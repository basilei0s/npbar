...
std::wstring HelpText() {
    ...
    s += L"\n";
    s += L"Hotkeys (watch mode):\n";
    s += L"  space                Toggle play / pause\n";
    s += L"  n / Right            Skip to next track\n";
    s += L"  p / Left             Skip to previous track\n";
    s += L"  ?                    Hold to show the hotkey overlay\n";
    s += L"  q / Esc / Ctrl+C     Quit\n";
    return s;
}
